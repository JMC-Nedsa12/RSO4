...
public class Nal7 extends Application {
    ...
    public void drawTree (Tocka t0, double dolzina, double kot){
        double x0, y0, x2, y2, rad, y3, x3, y4;
        
        if (flag==false){
            gc1.strokeLine(t0.getX(),t0.getY(),dolzina+t0.getX(),t0.getY());
            t0.setX(dolzina+t0.getX());
