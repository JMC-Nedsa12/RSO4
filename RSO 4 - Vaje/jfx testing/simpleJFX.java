...
/**
 * Write a description of JavaFX class simpleJFX here.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class simpleJFX extends Application
{
    ...
    public void start(Stage stage)
    {
        ...
        Button myButton1 = new Button("Subtract");
