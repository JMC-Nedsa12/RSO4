...
/**
   ...
   narise kochov fraktal določene stopnje iz premice:
      vnos vrednosti v polje določi stopnjo fraktala
      gumb ga nariše
...
public class KochStopnja extends Application {
    ...
    private Button btn;
    private TextField inputStopnja;
    int stopnja;
    ...
    private void createButton(){
        ...
        inputStopnja = new TextField();
        inputStopnja.setPromptText("Vnesi stopnjo fraktala");
        btn.setOnAction(new EventHandler<ActionEvent>() {
                @Override public void handle(ActionEvent e) {
                    // tule lahko startas
                    stopnja = Integer.valueOf(inputStopnja.getText());
                    drawFractal(10,100,290,100,stopnja-1);
                }
        });
    ...
    public void drawFractal (int x1, int y1, int x5, int y5, int stopnja)
{
        ...
        if ( stopnja < 1 )
            ...
            drawFractal (x1, y1, x2, y2,stopnja);
            drawFractal (x2, y2, x3, y3,stopnja);
            drawFractal (x3, y3, x4, y4,stopnja);
            drawFractal (x4, y4, x5, y5,stopnja);
            }
}
    ...
    private void addLayers(){
        ...
        borderPane.setBottom(inputStopnja);
        Pane pane = new Pane();
